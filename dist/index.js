...
const player = new Player({
    ...
    mediaElement: (_a = document.querySelector('#media')) !== null && _a !== void 0 ? _a : undefined,
});
...
function onAppReady(app) {
    ...
    if (!app.managed) {
        ...
        jumpBtn === null || jumpBtn === void 0 ? void 0 : jumpBtn.addEventListener('click', () => player.video &&
            player.requestMediaSeek(player.video.firstChar.startTime));
        // 一時停止ボタン / Pause music playback
        pauseBtn === null || pauseBtn === void 0 ? void 0 : pauseBtn.addEventListener('click', () => player.video && player.requestPause());
        // 巻き戻しボタン / Rewind music playback
        rewindBtn === null || rewindBtn === void 0 ? void 0 : rewindBtn.addEventListener('click', () => player.video && player.requestMediaSeek(0));
        (_a = document
            .querySelector('#header a')) === null || _a === void 0 ? void 0 : _a.setAttribute('href', 'https://developer.textalive.jp/app/run/?ta_app_url=https%3A%2F%2Ftextalivejp.github.io%2Ftextalive-app-basic%2F&ta_song_url=https%3A%2F%2Fwww.youtube.com%2Fwatch%3Fv%3DygY2qObZv24');
    }
    else {
        (_b = document
            .querySelector('#header a')) === null || _b === void 0 ? void 0 : _b.setAttribute('href', 'https://textalivejp.github.io/textalive-app-basic/');
    }
